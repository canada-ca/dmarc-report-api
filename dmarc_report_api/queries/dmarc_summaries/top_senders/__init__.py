...
from dmarc_report_api.queries.dmarc_summaries.top_senders.dkim_misaligned import DKIMMisaligned
from dmarc_report_api.queries.dmarc_summaries.top_senders.dkim_failure import DKIMFailure
from dmarc_report_api.queries.dmarc_summaries.top_senders.dmarc_failure import DMARCFailure
from dmarc_report_api.queries.dmarc_summaries.top_senders.spf_failure import SPFFailure
from dmarc_report_api.queries.dmarc_summaries.top_senders.spf_misaligned import SPFMisaligned
